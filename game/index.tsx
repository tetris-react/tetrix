...
const Play = (props: PlayProps) => {
  ...
  const { gameOver, score, level, rowsCleared, tetrisNum, tetrisRate } = useSelector(
  ...
  return (
    <AppContainer>
      <Navigation refetch={refetch} session={session} setToggleView={setToggleView} />
      ...
      <RegisterModal refetch={refetch} session={session} refetchLeaderBoard={refetchLeaderBoard} />
